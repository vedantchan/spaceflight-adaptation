...
function [keypermin, cleanedintervals, keyhold] = keystrokegen(subjdatafold, subjnum, switchtimesheet)
    % function takes in a subject folder with split data (so one subject
    % folder), the subject number, and specified switch time sheet (the
    % file itself)
