...
%
% $Date: 2016/07/13 08:11:50 $
% $Revision: 2.13 $
%
% $Log: crqad.m,v $
% Revision 2.13  2016/07/13 08:11:50  marwan
% normalization bug in crqad fixed
%
% Revision 2.12  2016/03/03 14:57:40  marwan
...
%
% Revision 2.11  2013/08/20 11:59:54  marwan
...
x=crp2(x1,x2,m,t,e,method,'sil',check_norm{nonorm+1});
warning off
  N=size(x);
