...
shimPath = uigetdir;
cd(shimPath);
mainfolder = 'ShimEpochAnalysis_displacement';
% headfolder = 'Head';
% bodyfolder = 'Body';
...
%                 velrt = rT.*time;
                ...
                dispx = detrend((1/2).*x.*(time.^2));
                dispy = detrend((1/2).*y.*(time.^2));
                dispz = detrend((1/2).*z.*(time.^2));
                disprt = detrend((1/2)*(rT.*(time.^2)));
                ...
                UP1(9) = peak2peak(dispx);
                UP1(10) = peak2peak(dispy);
                UP1(11) = peak2peak(dispz);
                UP1(12) = peak2peak(disprt);
                UP1(17) = max(disprt);
                UP1(18) = min(disprt);
