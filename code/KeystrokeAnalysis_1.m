...
%% mistakes
    ...
    f = file{i}(1:end-4);
    T = table(average,mistakes);
    writetable(T,strcat(d,file{i}(1:end-4), '_avg+mistakes.csv')); % NEED TO SPECIFY DIRECTORY: this will be determined after the shim data is done (there is one directory per person)
